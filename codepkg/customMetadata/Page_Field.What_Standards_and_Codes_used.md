...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>What Standards and Codes used?</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe and cite which Standards and Codes will be utilized for the proposed project.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">What_Standards_and_Codes_used__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Reference: 2015 HMA Guidance, Part IV H.1.1 &amp; H.4.2

If your community has adopted codes and standards which will be applied to this project (e.g. all stormwater infrastructure must be designed to 25 year flood event) please discuss, cite relevant code and attach documentation.</value>
    </values>
    <values>
