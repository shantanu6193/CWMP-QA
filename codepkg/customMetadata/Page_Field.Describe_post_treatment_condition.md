...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Describe post-treatment condition</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Provide a narrative describing the desired post-treatment condition of each treatment area.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe_post_treatment_condition__c</value>
    </values>
    <values>
...
• a description of vegetation variables expected to not change;
• a narrative describing what the dominant tree species and understory species would be; 
• list the approximate range of heights and dbh of trees for each dominant tree species; and
• list approximate estimate of stems (trees) per acre for each dominant species.</value>
    </values>
    <values>
