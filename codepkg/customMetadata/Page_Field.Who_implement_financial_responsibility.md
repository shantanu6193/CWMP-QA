...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Who implement, financial responsibility</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe who will be implementing the project and the financial arrangements in place.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Who_implement_financial_responsibility__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Examples of relevant financial arrangements include the folllowing: 
• Will the subapplicant be performing the work via direct contract or government staff? 
• Will homeowners or HOAs be contracting the work and filing with the subapplicant for reimbursement? Or will there be a combination of activities and responsibilities? 
• How will the subapplicant be involved in design and monitoring of project activities on public and private lands? 
• Will the subapplicant be preparing individual site treatment plans that the private owners will implement? 
• Will the subapplicant be providing a list of Licensed, Qualified Contractors who are not Suspended or Debarred, and providing a means for new Contractors to be evaluated and added to the list? 
• What is the match/cost share source and how will it be documented?</value>
    </values>
    <values>
