...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Exisiting drainage conditions and map</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe the existing drainage conditions  requiring mitigation and attach a map of both the drainage area and the area to be protected.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Exisiting_drainage_conditions_and_map__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Reference: 2015 HMA Guidance, Part IV H.1

Reference: 2015 Addendum, F. Supplemental Guidance 

Ex: describe impacts resulting from undersized infrastructure, the slope conditions requiring stabilization, or the proposed dam, levee improvements and how these actions will reduce risk to the area to be protected.

If able, attach a map and/or a hydrology and hydraulics (H&amp;H) analysis of the drainage area</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Drainage_Project_Site_Address</value>
    </values>
    <values>
