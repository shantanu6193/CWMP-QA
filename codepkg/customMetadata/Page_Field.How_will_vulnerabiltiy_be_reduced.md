...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>How will vulnerabiltiy be reduced?</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe how the proposed mitigation activities significantly reduce the vulnerability of target structures or facilities to the identified hazards?</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">How_will_vulnerabiltiy_be_reduced__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">• Are the project sites clustered into a few discrete areas, so as to maximize effectiveness? This will also minimize the geographic area for which EHP review is required. 
• Are the sites within defined subdivisions, enabling EHP review to cover the entire subdivision and so reducing EHP review time for future projects including properties in said subdivision?

 (e.g. % of total parcels to be treated, acreage to be treated, or some other quantification.) 



Reference: 2015 HMA Guidance Addendum, B.3, Reference: 2015 HMA Guidance IV J.</value>
    </values>
    <values>
