...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Describe the plan adoption process.</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe the plan adoption process.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe_the_plan_adoption_process__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Should include the process for FEMA and State review of drafts and final product, including draft submittals at least six month before the end of the Period of Performance, and the process for review and adoption by each participating jurisdiction

Reference: 44 CFR 201.6 (D) &amp;                                    FEMA&apos;s Local Mitigation Plan Review Guide</value>
    </values>
    <values>
