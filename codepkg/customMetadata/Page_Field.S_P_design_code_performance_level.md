...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>S/P design code performance level</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Provide a description of the design performance level/residual risk remaining after the mitigation action is completed.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">S_P_design_code_performance_level__c</value>
    </values>
    <values>
