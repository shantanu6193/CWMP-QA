...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Types of vegetation/fuels to be removed</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Provide a narrative describing the proposed types of vegetation/fuels to be removed?</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Types_of_vegetation_fuels_to_be_removed__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">• A description of the proposed activities, including removal of tree branches vertical and horizontal, and flammable vegetation. 
• List species of live trees proposed to be thinned for each treatment area (i.e. each group of structures/homes if/when there are multiple such groups, not by individual homes).
• List species of dead trees proposed to be removed for each treatment area.
• List approximate range of numbers of live trees by species proposed to be removed per site?


Reference: 2015 HMA Guidance Addendum, B.4.3</value>
    </values>
    <values>
        <field>Hide_Field_API_Name__c</field>
        <value xsi:type="xsd:string">Select_applicable_project_type_formula__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Defensible Space,Hazardous Fuels Reduction</value>
    </values>
    <values>
