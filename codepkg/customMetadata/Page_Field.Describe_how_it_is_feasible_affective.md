...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Describe how it is feasible &amp; affective</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe how the proposed project approach/design is feasible and effective in mitigating the identified risk.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe_how_it_is_feasible_affective__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe current state of components involved (ditches, culverts, swales, debris basins), including level of protection they provide (e.g. 10, 50, 100 year flood) and how these components will be modified during the project to reduce risk from the identified hazard.

Reference: 2015 HMA Guidance IV H.1.1 &amp; 2015 HMA Addendum, F.3</value>
    </values>
    <values>
