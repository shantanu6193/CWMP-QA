...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Seismic design code performance level</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe the level of protection (seismic design code performance level) of the proposed mitigation activity.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Seismic_design_code_performance_level__c</value>
    </values>
    <values>
