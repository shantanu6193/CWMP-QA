...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Will herbicides/bilogicials be used?</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Will herbicides and/or biological controls be used to control noxious weeds?</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Will_herbicides_bilogicials_be_used__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Include but not necessarily limited to:
o List herbicides or bio-controls proposed for use.
o List targeted species for treatment.
o Provide a description of conditions under which herbicides would be applied.
o Provide a description of best management practices, standards, or conditions which will be applied to herbicide use.
o List acreages at each treatment site proposed to be treated.
o Describe which agency(s) have certified intended application, including any use near aquatics and/or near any ESA species present in treatment area(s). If ESA-listed species are potentially present, has USFWS and/or NMFS consulted on use of the herbicides and or biological controls proposed in regions proposed for use.
o Were any Tribes consulted to identify if there are any traditional/ceremonial food gathering areas that could be affected by the herbicide and or bio-control?
o Describe method(s) of dispersal, including types of equipment. 
o Describe proposed timing of herbicide and or biological control use (range of dates).</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Project_Site_Details_Wildfire_Veg</value>
    </values>
    <values>
