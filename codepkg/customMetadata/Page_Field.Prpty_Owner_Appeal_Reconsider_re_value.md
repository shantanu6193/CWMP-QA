...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Prpty Owner Appeal/Reconsider re value</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe the Property Owner Appeal / Reconsideration Process regarding the value for the mitigation offer of the property.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Prpty_Owner_Appeal_Reconsider_re_value__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">An appeal or reconsideration process must be documented and followed for property owners who dispute the purchase offer property valuation. For example, if a homeowner if not happy with the appraisal value of their property, they may seek their own appraisal, and the original appraisal and homeowner appraisal will be averaged.

Reference: 2015 HMA Guidance Addendum, A.4.3</value>
    </values>
    <values>
