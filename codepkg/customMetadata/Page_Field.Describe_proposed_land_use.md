...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Describe proposed land use</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe the proposed land use of the acquired site(s)?</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe_proposed_land_use__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Allowable land uses for open space generally include parks for outdoor recreational activities, wetlands management, nature reserves, cultivation, grazing, camping (except where adequate warning time is not available to allow for evacuation), unpaved surfaces, and other uses that FEMA determines are compatible with the award and deed restrictions. 

Reference: 2015 HMA Guidance Addendum, A.4.4 &amp; A.6.1.</value>
    </values>
    <values>
