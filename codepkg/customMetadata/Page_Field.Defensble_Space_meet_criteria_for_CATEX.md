...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Defensble Space meet criteria for CATEX?</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Does the Defensible Space project meet the eligibility criteria to be considered for a Categorical Exemption (CATEX)?</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Defensble_Space_meet_criteria_for_CATEX__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Defensible space beyond 100 feet of the structure may be eligible for HMA funding, but will move the project from CATEX to EA.

• The total combined treatment area is limited to 100 acres. 
• All work must occur within 100 feet of at-risk structures. And 
• no limbs or trunks larger than 12-inch diameter will be removed.</value>
    </values>
    <values>
