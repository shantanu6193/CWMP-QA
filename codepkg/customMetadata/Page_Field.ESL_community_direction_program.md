...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>ESL community direction program?</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Is a proposed community direction program provided in the scope of work (SOW) and does it describe how the program will consider providing directions for individuals with limited English proficiency?</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">ESL_community_direction_program__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Examples of community direction program include signage, sidewalks, street crossings, etc.

Reference: 2015 HMA Guidance Addendum: C.3.1.3.2 &amp; ADA Compliance C.4.2

DHS Guidance to Federal Financial Assistance Recipients Regarding Title VI Prohibition Against National Origin Discrimination Affecting Limited English Proficient Persons</value>
    </values>
    <values>
