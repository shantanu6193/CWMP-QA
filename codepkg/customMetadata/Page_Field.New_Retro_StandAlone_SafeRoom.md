...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>New or retro, stand alone or internal?</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Is this a new stand-alone, retrofit stand-alone, new internal or retrofit internal safe room?</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">New_or_retro_stand_alone_or_internal__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">The stand-alone safe room is a separate building (i.e. not within or attached to any other building) that is designed and constructed or retrofitted to withstand extreme winds and the impact of wind-borne debris during tornadoes, hurricanes, or other extreme-wind events.

The internal safe room is a specially designed and constructed room or area within or attached to a larger building. An internal safe room (room or area) should be designed and constructed or retrofitted to be structurally independent of the larger building, but provide the same wind and wind-borne debris protection as a stand-alone safe room.

Reference: 2015 HMA Guidance Addendum, C.1.; FEMA P-361, A1.3.2</value>
    </values>
    <values>
