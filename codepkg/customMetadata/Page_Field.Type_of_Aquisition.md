...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Type of Aquisition</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Select the type of acquisition for the proposed project:</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">If the acquired structure will be destroyed, select demolition
If the acquired structure will be moved to a separate parcel outside the hazard area, select relocation</value>
    </values>
    <values>
