...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Describe aquisition activity</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe the proposed acquisition activity and how it will be accomplished.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe_aquisition_activity__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Indicate how many properties, the valuation method , personnel  managing the project and completing the tasks involved. Timeline of acquiring the properties along with demolition/relocation, and priority of selected properties.

All structures must be demolished or removed within 90 days. Thought should be put into meeting the 90 requirement with projects that have multiple structures. Local, State, and Federal procurement requirements must be followed 

Reference: 2015 HMA Guidance, Part IV H.1.1; 2015 HMA Guidance Addendum, A.3</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Acquisition_Demo_Relocation</value>
    </values>
    <values>
