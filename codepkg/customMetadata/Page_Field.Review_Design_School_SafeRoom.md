...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>review of design for schools/special pop</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">If designed for 50 or more occupants or designed for schools and other special populations, provide the structural and non-structural peer reviews of the design. If not available, when will they be provided?</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">review_of_design_for_schools_special_pop__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Peer Reviews are required by FEMA P-361 and ICC 500-2014 for community safe rooms including the following:
-Community safe rooms in elementary schools, secondary schools, and day care facilities with an occupant load greater than 16
-Safe rooms in Risk Category IV (essential facilities) such as fire, rescue, ambulance and police stations; medical facilities with surgery or emergency treatment facilities; designated earthquake, or other emergency shelters and designated emergency preparedness, communications, and operations centers and other facilities required for emergency response.

Reference: 2015 HMA Guidance Addendum, C.2.1, C.4.3.; FEMA P-361, B1.2.2.2</value>
    </values>
    <values>
