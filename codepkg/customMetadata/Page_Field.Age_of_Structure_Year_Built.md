...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Age of Structure (Year Built)</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Age of Structure (Year Built)</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Age_of_Structure_Year_Built__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">RM 12/29: Validation to not accept non-numeric values, needs to be 4 digits. Do not want to use number field as SF will automatically add the decimal</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Please enter the valid year</value>
    </values>
    <values>
