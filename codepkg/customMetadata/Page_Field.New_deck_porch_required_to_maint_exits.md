...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>New deck/porch required to maint. exits?</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Are new decks or porches required to replace patio areas that are accessed via exterior doors (so the door does not open to thin air)?</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">New_deck_porch_required_to_maint_exits__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Construction of new stairs, landings, and railings to access the elevated living space per minimum code or local ordinance

Reference: 2015 HMA Guidance, E.4.2</value>
    </values>
    <values>
