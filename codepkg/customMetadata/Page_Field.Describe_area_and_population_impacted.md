...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Describe area and population impacted</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Provide a detailed description of the area and population that will be impacted by this project.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Describe_area_and_population_impacted__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Include a description of the natural and built environments proposed project is intended to protect.  This discussion may be inclusive of the following: acreage, number of residences/ structures/businesses and or facilities, and should include size of population (traffic counts/estimates for road facilities if applicable) directly benefiting from the proposed project.  This information should be consistent with information used in the BCA.</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Project_Alternatives</value>
    </values>
    <values>
