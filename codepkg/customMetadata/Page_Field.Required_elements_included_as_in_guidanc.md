...
<CustomMetadata xmlns="http://soap.sforce.com/2006/04/metadata" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema">
    <label>Required elements included as in guidanc</label>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">If yes, does it include the required elements as detailed in the guidance?</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Required_elements_included_as_in_guidanc__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">The O&amp;M plan must include:
♦ A description of the maintenance procedures.
♦ A brief statement about the operation of the evacuation shelter when it is in use.
♦ Basic information about how the evacuation shelter will be used, including how use is initiated, the warning system, and basic procedures for opening the doors to the public.
♦ Key components of the evacuation shelter maintenance procedures.
♦ The office that will be responsible for the operation and maintenance of the evacuation facility.
♦ Assurance that the O&amp;M Plan will be developed and completed before project closeout.

Reference: 2015 HMA Guidance Addendum: C.5.1</value>
    </values>
    <values>
        <field>Hide_Field_API_Name__c</field>
        <value xsi:type="xsd:string">Operations_Maintenance_Plan_in_SOW__c</value>
    </values>
    <values>
    ...
    <values>
        ...
        <value xsi:type="xsd:string">Tsunami</value>
    </values>
    <values>
