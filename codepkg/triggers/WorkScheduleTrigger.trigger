trigger WorkScheduleTrigger on Work_Schedule__c (before insert, after insert, before update, after update) {
    Map<String, Object> triggerConfigMap = new TriggerHandler().instantiateApplicationHandlerClass('Work_Schedule__c');
