trigger RFITrigger on Request_For_Information__c (before insert, before update, after insert,after update, before delete) {
    //new HMARFITriggerHandler().process();

    Map<String, Object> triggerConfigMap = new TriggerHandler().instantiateApplicationHandlerClass('Request_For_Information__c');
