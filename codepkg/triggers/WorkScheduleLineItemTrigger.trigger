trigger WorkScheduleLineItemTrigger on Work_Schedule_Line_Item__c (before insert, after insert, before update, after update) {
    Map<String, Object> triggerConfigMap = new TriggerHandler().instantiateApplicationHandlerClass('Work_Schedule_Line_Item__c');
