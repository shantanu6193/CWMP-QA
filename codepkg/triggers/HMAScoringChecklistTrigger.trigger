trigger HMAScoringChecklistTrigger on Scoring_Checklist__c (before insert, after insert, before update, after update) {
    new HMA_ScoringChecklistTriggerHandler().process();
    /*Map<String, Object> triggerConfigMap = new TriggerHandler().instantiateApplicationHandlerClass('Scoring_Checklist__c');
