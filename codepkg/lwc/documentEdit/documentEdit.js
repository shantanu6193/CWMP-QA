...
export default class DocumentEdit extends LightningElement {
    ...
    handleSubmit(event){
       ...
       // fields.LastName = 'My Custom Last Name'; // modify a field
        console.log(this.template.querySelector('lightning-record-form').submit(fields));
        console.log("Inside Handle Submit-- after");
     }
}*/
/**
 * Created by harsh on 24-03-2021.
 */
