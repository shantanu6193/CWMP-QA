...
export default class HhSendEmailInternalComponent extends Utility {
    ...
    initData(){
        ...
        handleGetDataResponse(response) {
            ...
            this.relatedRecordName = response.houseHoldNumber;
    ...
    sendEmail(){
        ...
        console.log('this it the form email' + this.fromValue  );
        if(this.fromValue == ''){
                         // Show success messsage
                         this.dispatchEvent(new ShowToastEvent({
                            title: 'Error',
                            message: 'Please enter a From Email!',
                            variant: 'error'
                        }),);
